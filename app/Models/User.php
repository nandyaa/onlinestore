...
class User extends Authenticatable
{
     ...
     */
    // 100% SESUAI MODUL: Hanya name, email, password, dan balance yang boleh diisi massal
    protected $fillable = [
        'name',
        'email',
        'password',
    ...
    // --- GETTERS & SETTERS (SESUAI MODUL DANIEL CORREA) ---
    ...
    // ==========================================
    // KODE BARU CHAPTER 26: RELASI KE ORDER
    // ==========================================
